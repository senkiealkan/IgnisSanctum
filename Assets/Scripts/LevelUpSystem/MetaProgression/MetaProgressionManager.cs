...
public class MetaProgressionManager : MonoBehaviour
{
    ...
    public int currentRunStatGems; 
    public int currentRunFireGems;
    ...
    public float GetMetaFireDamageBonus() => fireDamageLevel * 5f;  // Mỗi cấp tăng 5 damage
    ...
    public float GetMetaManaRegenBonus() => manaRegenLevel * 0.25f;    // +25% tốc độ hồi mỗi cấp
